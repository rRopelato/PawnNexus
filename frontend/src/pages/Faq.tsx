    ...
    items: [
      {
        ...
        answer: "PawnNexus is a community website for sharing Dragon's Dogma 2 Pawns. You can browse approved Pawns, search by basic filters, and submit your own Pawn for other players to find.",
      },
      {
        question: 'Is this an official Capcom project?',
        answer: 'No. PawnNexus is an independent fan and portfolio project. It is inspired by PawnGuild.xyz, but it is not affiliated with Capcom and does not use official game assets.',
      },
      {
        question: 'Why is the site in testing?',
        answer: 'The project is still evolving. Features, database structure, and moderation tools may change while the MVP is being tested. The goal is to keep it simple, fast, and safe before adding larger community features.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer: 'Create an account, verify your email, open Add Pawn, fill in the Pawn details, upload images, and submit. New Pawns enter moderation before appearing publicly.',
      },
      {
        question: 'Why is my Pawn pending?',
        answer: 'Every new or edited Pawn is reviewed first. This helps avoid spam, broken images, offensive submissions, and fake listings.',
      },
      {
        question: 'Why do I need to refresh my Pawn?',
        answer: 'Pawn activity is based on weekly refreshes. Pawns start at 3 stars. If you do not refresh a Pawn each week, it loses activity. At 1 star it stops appearing in public browsing, but it can still be seen on your profile.',
      },
      {
        question: 'What if I do not want to show my platform ID?',
        answer: 'Steam, PSN, Xbox Gamertag, and Nintendo Switch 2 friend ID are optional. If you leave one empty, public pages show Not filled instead of exposing private information.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer: 'Each Pawn can have up to 5 images. Browse pages load only the thumbnail, while the Pawn details page loads the full carousel on demand.',
      },
      {
      ...
      },
      {
        ...
        answer: 'The first image is used as the main thumbnail in Browse. You can reorder images while editing or adding a Pawn.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer: 'Email verification helps reduce spam and account abuse. Unverified users can log in and browse, but cannot add Pawns, upload images, refresh listings, or use moderation tools.',
      },
      {
        question: 'Can users see my email?',
        answer: 'No. Public pages use your username. Email is used for login, verification, password reset, and admin safety tools.',
      },
      {
        question: 'How does password reset work?',
        answer: 'Password reset links are sent by email and expire after 1 hour. PawnNexus stores only a hash of reset tokens, never the raw token.',
      },
      {
...
export function Faq() {
  return (
    <div className="mx-auto max-w-5xl space-y-8">
      <section className="grid gap-6 border-b border-white/10 pb-8 lg:grid-cols-[1fr_280px] lg:items-end">
        <div className="space-y-4">
          <p className="text-sm uppercase tracking-[0.2em] text-ember-500">FAQ</p>
          <h1 className="max-w-3xl text-4xl font-semibold text-white md:text-5xl">PawnNexus FAQ</h1>
          <p className="max-w-3xl text-zinc-400">
            Quick answers about accounts, moderation, images, privacy, and how the project works.
          </p>
        </div>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        {faqSections.map((section) => {
          ...
          return (
            <section key={section.title} className="rounded border border-white/10 bg-ash-900 p-4">
              <div className="mb-3 flex items-center gap-3">
                <span className="grid h-9 w-9 shrink-0 place-items-center rounded border border-ember-500/35 bg-ash-850 text-ember-500">
                  <Icon size={18} />
                </span>
      ...
      <section className="grid gap-4 lg:grid-cols-[1fr_1fr]">
        <InfoCard icon={<Github size={18} />} title="Made by rRopelato">
          <p className="text-sm leading-6 text-zinc-400">
            PawnNexus is a portfolio project and a lightweight DD2 community tool built by {creator.name}.
          </p>
          <LinkRow />
        </InfoCard>
        ...
        <InfoCard icon={<Heart size={18} />} title="Support the project" highlight wide>
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            <Link className="button-primary" to="/support">Support</Link>
      ...
      <section className="rounded border border-white/10 bg-ash-900 p-4">
        <div className="flex gap-3">
          <span className="grid h-9 w-9 shrink-0 place-items-center rounded border border-white/10 bg-ash-850 text-ember-500">
            <Mail size={18} />
          </span>
          <div className="min-w-0">
            <h2 className="text-lg font-semibold text-white">Contact</h2>
            <p className="mt-1 text-sm leading-6 text-zinc-400">
              Contact me through GitHub, LinkedIn, or Discord. For portfolio and other projects, visit ropelato.dev.br.
            </p>
            <LinkRow showDiscord />
          </div>
        </div>
...
function LinkRow({ showDiscord = false }: { showDiscord?: boolean }) {
  return (
